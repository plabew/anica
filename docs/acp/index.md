...
| User Guide | User asks CLI setup/install/login steps for external command tools (for example Codex CLI, Gemini CLI, Claude CLI, or OpenCode CLI). | `anica/docs/acp/userguide/catalog.md` |
