...
| TOOL-0003 | Timeline analysis/edit-plan tools | User asks timeline snapshot, silence/subtitle gaps, SRT import, or any validate/apply edit operation. | `timeline`, `silence`, `subtitle`, `srt`, `import_srt`, `audio_silence_cut_plan`, `subtitle_gap_cut_plan`, `validate`, `apply`, `track_ops`, `clip_ops`, `subtitle_ops`, `effect_ops`, `transition_ops` | `anica/docs/acp/tools/TOOL-0003.md` |
